...
<form id="insertFrm" method="post" class="form">
        <table  style="padding-top:50px"  align = center width=840 border=0 cellpadding=2 >
                <tr>
                <td class="title" height=40 align= center bgcolor=#ccc ><font color=whit> 글쓰기</font></td>
                </tr>
                <tr>
                <td bgcolor=white>
                <table class = "table2">
                        ...
                        <tr>
                        <td>작성자</td>
                        <td><input type="text" name="boardMemberName" id="boardMemberName" value="${loginName}" readonly/> </td>
                        </tr>
                        <td>작성Id</td>
                        <td><input type="text" name="boardMemberId" id="boardMemberId" value="${loginId}"  readonly/> </td>
                        </tr>
 
                        <tr>
                        <td>제목</td>
                        <td><input type="text" name="boardTitle" id="boardTitle" maxlength="30" style="width:700px;"  placeholder="30자이내로 제목을 작성 해주세요"/></td>
                        </tr>
 
                        <tr>
                        <td>내용</td>
                        <td><textarea cols=85 rows=15 id="boardContent" name="boardContent" maxlength="500" placeholder="500자 이내로 입력하세요." style="word-wrap:break-word;"></textarea></td>
                        </tr>
                        </table>
 
                        <div class="btn">
                        <button type="button" id="listBtn" >목록가기</button>
                        <button type="button" id="insertBtn" style="margin-right:10px;" >등록</button>
                        </div>
                </td>
                </tr>
        </table>
